onload=()=>{
    ...
    document.querySelector("#btn-0").onclick = () => cards(3);
    document.querySelector("#btn-1").onclick = () => plataformas(3);
...
async function destaques() {
    let data = await fetch ("https://api.rawg.io/api/games?page=1&page_size=4&key=32db20030f844c42ac056a9e17c926bd")
    .then((res)=>res.json());
...
var url0 =
  "https://api.rawg.io/api/games?page=1&page_size=4&key=32db20030f844c42ac056a9e17c926bd";
  ...
  for (let index = 0; index < data.results.length; index++) {
    ...
    <div class="card border border-0">
        ...
        <div class="card-body">
            ...
            <a href="plata.html?${plataforma.id}"><button type="button" class="btn btn-secondary">Mais detalhes ...</button></a>
        </div>
    </div>
   </div>`;
  }
